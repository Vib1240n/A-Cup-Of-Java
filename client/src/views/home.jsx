                ...
                <m.Box style={styles.listItemBox}>
                    <m.Box
                        sx={{
                            ...
                            width: "100vw",
                            display: "grid",
                            gridTemplateColumns: {xs: "50%", xl: "repeat(3, 1fr)", md: "50%"},
                    ...
                    >
                        <m.Card
                            sx={{
                                ...
                                flexDirection: "column",
                                margin: "auto",
                                gridColumn: {md: expandedBarber2 ? "3" : "1", xl: "1", lg: "1"},
...
//                                marginRight: {xs: "0px"},
                        ...
                        >
                            ...
                            <m.CardMedia component="img" image={barber3} alt="Barber-jimmy" sx={{
                                display: "flex",
                                margin: "auto",
                                height: "90%",
                                width: "90%",
                        ...
                        >
                            <m.CardHeader title="Elena" sx={{
                                color: "white",
                                display: "flex",
                                flexDirection: "column",
                                margin: "auto",
                            }}/>
                            <m.CardMedia component="img" image={barber2} alt="Barber-Elena" sx={{
                                display: "flex",
                                margin: "auto",
                                height: "90%",
                                width: "90%",
