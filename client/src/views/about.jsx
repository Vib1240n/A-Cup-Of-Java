    ...
    <div>
      ...
      <div class = "about-middleelement">
          <div class = "about-mid1"> 
            <div>
                <p id = "about-textundercontent1"> <strong id = "about-content1"> Welcome to our barbershop</strong><br/><br/>
          ...
          <div class = "about-mid2"> 
              ...
              <div id = "about-mid2image">
                <div class="maprouter">
                  <div>
                    <iframe width = "600" height = "350" src="https://maps.google.com/maps?q=1049%20Jefferson%20Blvd,%20West%20Sacramento%20,CA%2095691&t=&z=13&ie=UTF8&iwloc=&output=embed" 
                    frameborder="0" 
                    scrolling="no" 
                    marginheight="0" 
                    marginwidth="0">
